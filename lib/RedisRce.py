...
def redisRce(options):

    print("[*] Connecting to  {}:{}...".format(options.url, options.port))
    ...
    lhost = input("Input your listen host: ")
    lport = int(input("Input your listen port: "))
    runserver(options.url, options.port, lhost, lport)
